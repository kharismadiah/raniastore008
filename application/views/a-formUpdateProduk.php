            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="<?php echo site_url()."/Admin/dataReseller/"?>" class="waves-effect"><i class="fa fa-user fa-fw" aria-hidden="true"></i>Data Reseller</a>
                    </li>
                    <li>
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="page-scroll"><a href="<?php echo site_url()."/Admin/tombolTambahProduk/"?>">Tambah Produk</a></li>
                            <li class="page-scroll"><a href="<?php echo site_url()."/Admin/dataProduk/"?>">Edit Produk</a></li>
                        </ol>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <!-- .row -->
                <section id="updateDataProdukUpdate"> 
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <?php echo form_open_multipart(site_url('Admin/updateDataProduk/'.$id_produk));  ?>
                                <div class="form-group">
                                    <label class="col-md-12" for="id_produk">ID PRODUK</label>
                                    <div class="col-md-12">
                                        <input type="text" name="id_produk" class="form-control form-control-line" placeholder="" value="<?php echo $id_produk; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="nama_produk" class="col-md-12">NAMA PRODUK</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Masukkan Nama Produk" class="form-control form-control-line" name="nama_produk" value="<?php echo $nama_produk; ?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="merk_produk">MERK</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Masukkan Merk Produk" class="form-control form-control-line" name="merk_produk" value="<?php echo $merk_produk; ?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="kategori_produk">KATEGORI</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Masukkan Kategori Produk" class="form-control form-control-line" name="kategori_produk" value="<?php echo $kategori_produk; ?>"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="harga_produk">HARGA</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Masukkan Harga Produk" class="form-control form-control-line" name="harga_produk" value="<?php echo $harga_produk; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="gambar">GAMBAR</label>
                                    <div class="col-md-12">
                                        <input type="text" readonly placeholder="<?php echo $gambar; ?>" class="form-control form-control-line">
                                        <input type="file" name="gambar" size="20" placeholder="Masukkan Gambar Produk" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
