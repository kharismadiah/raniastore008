    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- .row -->
                <!-- <section id="createDataproduk">                
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="<?php echo base_url()."admin/plugins/images/large/img1.jpg"?>">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="<?php echo base_url()."admin/plugins/images/users/admin.png"?>" class="thumb-lg img-circle" alt="img"></a>
                                        <h4 class="text-white">Admin</h4>
                                        <h5><a href="" input type = "submit" value = "Edit"><span class="label label-warning">Edit</span></a></h5>
                                </div>
                            </div>
                        </div>
                    </div> -->
                    ...
                    <!-- <form role="form" enctype="multipart/form-data" method="post" action="<?php //echo site_url()."/welcome/createProduk/"?>"> -->
                    <!-- <?php //echo form_open_multipart(site_url('/welcome/createProduk'));  ?> -->
                    <div class="col-md-12 col-xs-12">
                        <div class="white-box">
                            <?php echo form_open_multipart(site_url('Admin/createProduk')); ?>
