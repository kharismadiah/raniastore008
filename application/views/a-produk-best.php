                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <form method="post" action="<?php echo site_url().'/Admin/readProdukIDBest'?>">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th>ID PRODUK</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                            <p><a href="<?php echo site_url().'/Admin/readProdukIDBest/'.$x['id_produk'] ?>" input type = "submit" value = "Edit"><span class="label label-warning">Edit</span></p>
                                            </td> 
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                            <form method="post" action="<?php echo site_url().'/Admin/deleteProdukBest/'?>"> 
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th></th>
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $x) { ?>
                                        <tr>
                                            <td><input type="checkbox" name="produk_hijab_best[]" value="<?php echo $x['id_produk']?>"></td>
                                            <td><?= $x['id_produk'] ?></td>
                                            <td><?= $x['gambar'] ?></td>
                                            <td><?= $x['nama_produk'] ?></td>
                                            <td><?= $x['merk_produk'] ?></td>
