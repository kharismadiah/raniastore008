            ...
            <div class="container-fluid">
                ...
                <!-- .row -->
                    <div class="col-md-8 col-xs-12">
                        <div class="white-box">
                            <?php echo form_open_multipart(site_url('Admin/updateDataProdukBest/'.$id_produk));  ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" disabled placeholder="Masukkan Gambar Produk" class="form-control form-control-line" value="<?php echo $gambar; ?>">
