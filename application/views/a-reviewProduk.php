            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <ol class="breadcrumb">
                            <li class="page-scroll"><a href="#updateAkunReseller">Update Review Hijab</a></li>
                            <li class="page-scroll"><a href="#deleteAkunReseller">Delete Review Hijab</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Update Data Review</h3>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?= $x['nomor'] ?></td>
                                            <td><?= $x['nama_review'] ?></td>
                                            <td><?= $x['email_review'] ?></td>
                                            <td><?= $x['pesan_review'] ?></td>
                                            <td><?= $x['datetime_review'] ?></td>
                                            <td><?= $x['status_review'] ?></td>
                                            <td align="left">
                                                <form action="<?php echo site_url()."/Admin/editStatusReview/".$x['nomor']; ?>" method="post">
                                                    <input type="radio" name="editStatusR" value="read">Read<br>
                                                    <input type="radio" name="editStatusR" value="unread">Unread<br>
                                                    <br>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Delete Data Review</h3>
                            <div class="table-responsive">
                            <form method="post" action="<?php echo site_url().'/Admin/deleteReview'?>"> 
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th></th>
                                    ...
                                    <tbody>
                                        <?php foreach ($data as $x) { ?>
                                        <tr>
                                            <td><input type="checkbox" name="review_hijab[]" value="<?php echo $x['nomor']?>"></td>
                                            <td><?= $x['nomor'] ?></td>
                                            <td><?= $x['nama_review'] ?></td>
                                            <td><?= $x['email_review'] ?></td>
                                            <td><?= $x['pesan_review'] ?></td>
